...
import { C as isRedirect, D as isNotFound, E as rootRouteId, S as executeRewriteInput, i as RouterProvider, k as invariant, t as renderRouterToStream, w as isResolvedRedirect, x as resolveManifestAssetLink } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DJoPk5vp.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DKRpPU2b.mjs"),
		import("./start-BPfIZlxr.mjs"),
