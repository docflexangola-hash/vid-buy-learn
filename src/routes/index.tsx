...
function Landing() {
  ...
  const paymentInstructions = siteConfig
    ? {
        bank: siteConfig.payment_bank,
        iban: siteConfig.payment_iban,
        holder: siteConfig.payment_holder,
        note: siteConfig.payment_note,
      }
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                >
                  <a href="#comprar">Comprar agora — {priceLabel}</a>
                </Button>
                <a
                  href="#beneficios"
            ...
            <div className="relative">
              ...
              <Card className="relative overflow-hidden border-border/60 bg-card p-8 shadow-xl">
                ...
                <div className="mt-4 rounded-xl bg-secondary p-5 text-center">
                  ...
                  <p className="mt-1 text-4xl font-extrabold text-primary">{priceLabel}</p>
                  <p className="mt-1 text-xs text-muted-foreground">Acesso vitalício ao curso</p>
                </div>
                <ul className="mt-5 space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <PlayCircle className="h-4 w-4 text-gold" /> Aulas em vídeo
                  </li>
                  <li className="flex items-center gap-2">
                    <Smartphone className="h-4 w-4 text-gold" /> Em qualquer dispositivo
                  </li>
                  <li className="flex items-center gap-2">
                    <Award className="h-4 w-4 text-gold" /> Certificado digital
                  </li>
                </ul>
              </Card>
            </div>
        ...
        <Card className="border-border/60 p-8 md:p-10">
          ...
          <div className="mt-10 rounded-xl border border-dashed border-border bg-background/60 p-6 text-sm">
            ...
            <ol className="mt-3 list-decimal space-y-1 pl-5 text-muted-foreground">
              ...
              <li>
                Faça o pagamento:{" "}
                <span className="font-medium text-foreground">{paymentInstructions.bank}</span> —
                IBAN <span className="font-mono">{paymentInstructions.iban}</span> (
      ...
      <section className="mx-auto max-w-3xl px-4 pb-24">
        ...
        <Accordion type="single" collapsible className="mt-6">
          <AccordionItem value="1">
            ...
            <AccordionContent>
              Não. O curso começa do absoluto zero e leva-o passo a passo até ao nível profissional.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="2">
            <AccordionTrigger>Por quanto tempo tenho acesso?</AccordionTrigger>
            <AccordionContent>
              O acesso é vitalício. Pode assistir e rever as aulas sempre que quiser.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="3">
            <AccordionTrigger>Como recebo o acesso depois do pagamento?</AccordionTrigger>
            <AccordionContent>
              Após confirmar o pagamento, o seu acesso é liberado manualmente em até 24h. Receberá
          ...
          <AccordionItem value="4">
            ...
            <AccordionContent>
              Sim. Ao concluir todas as aulas recebe um certificado digital de conclusão.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="5">
            <AccordionTrigger>Posso assistir pelo telemóvel?</AccordionTrigger>
            <AccordionContent>
              Sim, o curso funciona em qualquer dispositivo com acesso à internet.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
